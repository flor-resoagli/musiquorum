...
<main>
<form method="post" action="/searchForCourse.do">
    ...
    <section class="py-5 text-center container">
        <div class="row py-lg-5">
            <div class="col-lg-6 col-md-8 mx-auto">
                <h1 class="fw-light">Course List</h1>
                            ...
                            <div class="card shadow-sm">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <%--                                            <a href="${pageContext.request.contextPath}/secure/courses/${course.courseID}" class="btn btn-primary">Enroll for free</a>--%>
                                            <button type="button" class="btn btn-sm btn-outline-secondary">Edit</button>
                                        </div>
                                        <small class="text-muted">${course.professor}</small>
                                    </div>
                                </div>
                            </div>
